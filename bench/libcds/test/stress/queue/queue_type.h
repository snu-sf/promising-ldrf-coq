...
#define CDSSTRESS_MSQueue( test_fixture ) \
    /* CCDSSTRESS_Queue_F( test_fixture, MSQueue_HP         ) */ \
...
#define CDSSTRESS_MoirQueue( test_fixture ) \
    /* CCDSSTRESS_Queue_F( test_fixture, MoirQueue_HP       ) */ \
    CDSSTRESS_Queue_F( test_fixture, MoirQueue_HP_stat  ) \
    /* CCDSSTRESS_Queue_F( test_fixture, MoirQueue_DHP      ) */ \
    /* CCDSSTRESS_Queue_F( test_fixture, MoirQueue_DHP_stat ) */ \
