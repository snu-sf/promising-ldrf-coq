...
Proof.
  ...
  exploit pf_steps_cancels_not_cancels_no_sc.
  { etrans.
    { eapply STEPS. }
    { eapply STEPS0. }
  }
  ...
  { etrans.
    { eapply rtc_implies; cycle 1.
      ...
      { i. right. clear - H.
        ...
        unfold is_cancel in *. des_ifs. dup STEP0.
        inv STEP0; inv STEP; inv LOCAL. inv PROMISE. econs; eauto. }
    }
