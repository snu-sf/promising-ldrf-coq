...
| ctx_bind
    ...
    (SIM2: _sim_ktree sim_seq sim_ret1 k0 k1 sim_ret2):
    @ctx sim_seq
...
Lemma ctx_compat:
  ctx <12= gupaco11 _sim_seq (cpn11 _sim_seq).
Proof.
  assert (MON: monotone11 _sim_seq).
  (* paco tactics do not work well without this *)
  { eapply _sim_seq_mon; eauto. }
...
Lemma iter_ctx_compat:
  iter_ctx <12= gupaco11 _sim_seq (cpn11 _sim_seq).
Proof.
  assert (MON: monotone11 _sim_seq).
  (* paco tactics do not work well without this *)
  { eapply _sim_seq_mon; eauto. }
  ...
  { ii. inv RET.
    { guclo ctx_compat. eapply ctx_tau_iter; eauto.
      eapply _sim_ktree_mon; cycle 1; eauto.
      i. gbase. eapply _sim_seq_mon; eauto.
      i. eapply rclo11_base. eauto.
    }
...
Definition sim_itree := @_sim_itree sim_seq.
Definition sim_ktree := @_sim_ktree sim_seq.
